...
parser.add_argument('--project', required=True, choices=['Chart', 'Cli', 'Closure', 'Codec', 'Collections', 'Compress', 'Csv', 'Gson', 'JacksonCore', 'JacksonDatabind', 'JacksonXml',  'JxPath', 'Lang', 'Math', 'Mockito', 'Time', 'ToyExample'])
