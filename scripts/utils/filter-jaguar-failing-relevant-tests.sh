#! /bin/bash
#
# Filters only relevant spectra/matrix files generated by Jaguar.
# 
# Conditions to be considered a relevant coverage file:
#   - Contains at least one failing test case ("-") with at least one executed element ("1")
#
